            ...
            <div style="height: 143mm;padding: 5mm;">
                ...
                <div class="row">
                    <div class="col-lg-12" style="padding-bottom: 5px;">
                        <h4 style="margin: 0px;text-align:center;padding-bottom: 10px;border-bottom: 1px solid black;"><b>OPERATIVE NOTES</b></h4>
                    </div>
                </div><br>
                <div class="row" style="font-size: 13px">
                    <div class="row">
                            <div class="col-lg-10"></div>
                            <label class="col-lg-2">Date<i style="">:</i></label>
                ...
                <div class="row" style="font-size: 13px">
                    <div class="col-lg-7">
                        <div class="row">
                            <label class="col-lg-5">Procedure Performed<i style="float:right;">:</i></label>
                        </div>
                        <div class="row">
